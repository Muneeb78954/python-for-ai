...
dog1 = Dogg(name = "Buddy", breed = "Golden Retriever")
dog2 = Dogg(name = "Max", breed = "German Shepherd")
print(dog1.name)  # Output: Buddy
print(dog2.breed)  # Output: German Shepherd
print(dog1.bark())  # Output: Buddy says Woooooooooooooooof!
print(dog2.bark())  # Output: Max says Woooooooooooooooof!
...
config = APIConfig(api_key="sk-key")
...
print(my_dog.bark())   # Buddy says Woooooooooooooooof!